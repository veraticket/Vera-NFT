...
transaction (id: UInt64, type: String, maxTickets: UInt64, buyLimit: UInt64, tier: [{String: UInt64}], subtier: [{String: UInt64}], defaultRoyaltyAddress: Address, defaultRoyaltyPercent: UFix64, royalties:{UInt64:{Address:UFix64}}, eventURI: String, metadata: {String: String}) {
    ...
    execute {
        ...
        self.eventAdmin.updateEvent(id: id, type: self.eventType, tier: self.tier, maxTickets: maxTickets, buyLimit: buyLimit, defaultRoyaltyAddress: defaultRoyaltyAddress, defaultRoyaltyPercent: defaultRoyaltyPercent, royalty: self.royalty, royalties: self.accountRoyalty, eventURI: eventURI, metadata: metadata)
